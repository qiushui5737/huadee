<template>
  <div class="portal-shell">
    <header class="site-header">
      <div class="utility"><span>遂宁市人民政府门户网站</span><span>简体中文　｜　无障碍浏览</span></div>
      <div class="identity">
        ...
        <div class="account"><router-link to="/admin/login">群众登录</router-link><router-link class="register" to="/admin/register">注册</router-link></div>
      </div>
      <nav class="main-nav">
...
import { School, House, FirstAidKit, Briefcase, UserFilled, Van, Wallet, Document } from '@element-plus/icons-vue'
const serviceItems = [
